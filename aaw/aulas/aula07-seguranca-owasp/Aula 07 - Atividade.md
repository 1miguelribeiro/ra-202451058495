...
> **Nomes:** Miguel Ribeiro Muniz Morais   **Turma:** Quinta-feira noite **Data:** 17/09/2026
...
Pessoa consegue executar qualquer query no banco de dados.
3. Como corrigir?
Query parametrizada, protegendo os dados.
...
2. Qual o dano possível em produção?
Uma pessoa consegue visualizar fatura de outras pessoas.
3. Como corrigir?
Toda leitura ou escrita verifica qual o usuário que está logado.
...
1. Qual é a falha?
Credenciais inseridas direto no código.
2. Qual o dano possível em produção?
Usuário consegue pegar essas credenciais e acessar/utilizar recursos da empresa.
3. Como corrigir?
user-secrets
...
1. Qual é a falha?
Permite que o usuário altere seu Role.
2. Qual o dano possível em produção?
Usuário consegue ver informações de diferentes cargos no sistema. 
3. Como corrigir?
Remover edição de role do UsuarioUpdate.
## DESAFIO

1. Qual das 4 falhas um scanner automático de código teria MAIS dificuldade de encontrar? Por quê?

Vulnerabilidade 2, pois um scanner automático seria provável de procurar palavras chave no código, tipo "password", "role" ou queries expostas e acabaria ignorando a consulta de fatura por se tratar de um trecho de lógica do código.